<?php
/*   SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES - INDAIATUBA 24JUL22
     SISTEMA DESARROLLADO POR FRANCO VIEIRA MORALES - INDAIATUBA 24JUL22
     SYSTEM  DEVELOPED    BY  FRANCO VIEIRA MORALES - INDAIATUBA 24JUL22

  
     ÚLTIMA ALTERAÇÃO FRANCO VIEIRA MORALES - INDAIATUBA 24JUL22 - RES000101/13BR
                                                                   (19)3017-3460
                                                                   (19)99272-0159
                                                                   (19)99751-7645
...
/*SELECT cliNome, cliEndereco, cliNumero, cliCelular, cliMoto, cliPlaca, pedIteResponsavel, pedIteKm, pedIteData FROM clientes INNER JOIN pedidos_itens ON pedido_itens.pedIteCliente_fk = clientes.cliCodigo WHERE pedido_itens.pedItePedido_fk = '$pedido'*/
           $log = mysql_query("SELECT cliNome, cliEndereco, cliNumero, cliCelular, cliVeiculo, cliPlaca, pedResponsavel, pedKm, pedData FROM clientes INNER JOIN pedidos ON pedidos.pedCliente_fk = clientes.cliCodigo WHERE pedidos.pedCodigo = '$pedido'");
...
{  
     ...
     $pdf->Cell(440, 20, $cont['pedIteDescricao'], 1, 0, 'L');
