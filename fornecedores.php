...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="pinhelli pneus suspensão">
  ...
  <header class="header-bar d-flex d-lg-block align-items-center" data-aos="fade-left">
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        ...
        <li><a href="http://www.difranconaweb.com.br/pinhelli/ponteiro.php?sender=4">mercadoria</a></li>
        ...
        <li><a href="http://www.difranconaweb.com.br/pinhelli/ponteiro.php?sender=11">relatório</a></li>
...
<!-- ## SESSÃO DE CONTATO NA EMPRESA ## -->
                        ...
                        <ul class="copyright">
                            <li>&copy;<?php print Date('Y') ?>. PINHELLI PNEUS SUSPENSAO -  Fornecedores.</li>
                        </ul>  </br>
