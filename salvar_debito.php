<?php
/*   SISTEMA DESENVOLVIDO POR FRANCO VIEIRA MORALES - INDAIATUBA 14JUL23
     SISTEMA DESARROLLADO POR FRANCO VIEIRA MORALES - INDAIATUBA 14JUL23
     SYSTEM  DEVELOPED    BY  FRANCO VIEIRA MORALES - INDAIATUBA 14JUL23
     ...
     {// ALTERAR A FORMA DE PAGAMENTO //
        $sql = mysql_query("UPDATE carteira SET pagCliente_fk = '$idCliente', pagPedido_fk = '$pedido', pagStatus = 'FECHADO', pagFormaPagto = 2, pagBandeira = 'DEBITO', pagParcela = 1, pagValor = '$valor', pagDataPag = '$data', pagData = '$data', pagHora = '$hora', pagResponsavel = '$usuario' WHERE pagPedido_fk = '$pedido'");
         ...
         // ##   VERIFICA SE CONSTA ESTE PEDIDO DA VIARÁVEL NA TABELA DE CAIXA ## //
          ...
          mysql_query("INSERT INTO caixa (caxIdPedido_fk, caxDescricao, caxVlrEntrada, caxVlrSaida, caxData, caxHora, caxResponsavel)  VALUES ('$pedido','PAGAMENTO DEBITO ..: $pedido','$valor','','$data','$hora','$usuario')");}else{mysql_query("UPDATE caixa SET caxDescricao = 'PAGAMENTO DEBITO ..: $pedido', caxVlrEntrada = '$valor', caxData = '$data',caxHora = '$hora' WHERE caxCodigo = '$caxPedido'");}
          // ##  FINAL DE ROTINA ## //
